...
<html lang="zh-CN">
  <head>
    ...
    <link href="../css/存入金额.css" rel="stylesheet">
    <script type="text/javascript" src="../js/jquery.min.js"></script>
    <script src="../js/存入金额.js"></script>
  ...
  <body>
    <div class="container-fluid">
      ...
      <a href="gezijuti.php?id=<?php echo $id?>"><img src="../picture/左箭头白色.png" class="jiantou"height="25px" width="25px">
      </a>  
        存入金额
      </div>
    </div>
    ...
    <div class="container-fluid">
      <div class="row" id="left">
       ...
       <div class="col-xs-8">
         ...
         <div class="col-xs-12" id="ziright">
           可用额度2000元
         </div>
       </div>
       <div class="col-xs-2">
